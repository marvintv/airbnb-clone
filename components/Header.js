    ...
    return (
        ...
        <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10">
            ...
            <div className="flex flex-row items-center md:border-2 rounded-full py-2 md:shadow-sm">
                ...
                <input value={searchInput} onChange={(e)=> setSearchInput(e.target.value)} className="flex-grow pl-5 bg-transparent outline-none text-small text-gray-600 placeholder-gray-400" type="text" placeholder={placeholder || "Start Your Search"}/>
            ...
            <div className="flex items-center space-x-4 justify-end text-gray-500">
                ...
                <GlobeAltIcon className="h-6 space-x-2 cursor-pointer hidden md:inline-flex"/>
